...
class QuestionProcessor:
    ...
    def preprocess(question: str) -> str:
        ...
        processed = "".join(
            char for char in processed if char not in string.punctuation or char == "?"
        )
...
def ask_question():
    ...
    try:
        ...
        # SECURITY: Only use server-side API key from environment variable
        # Never accept API keys from client to prevent exposure
